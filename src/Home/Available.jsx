...
function Available() {
  return (
    <div className="min-h-[500px] bg-gradient-to-br from-orange-400 via-red-500 to-pink-600 flex items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="text-center relative z-10 max-w-2xl mx-auto">
        {/* Main Heading */}
        <div className="mb-8">
          <h1 className="text-6xl md:text-7xl font-black text-white mb-4 tracking-tight animate-pulse">
            <span className="bg-gradient-to-r from-yellow-300 to-orange-200 bg-clip-text text-transparent drop-shadow-2xl">
              COMING
            </span>
            <br />
            <span className="text-white drop-shadow-2xl">SOON</span>
          </h1>
        ...
        <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-3xl p-8 shadow-2xl mb-8">
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
            ...
            <div className="text-center">
              ...
              <div className="text-white text-lg font-bold">Play Store</div>
            </div>
        ...
        <div className="absolute -top-0 -right-6 animate-bounce">
          <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg transform rotate-12">
            SOON! 🚀
          </div>
        </div>
      </div>
